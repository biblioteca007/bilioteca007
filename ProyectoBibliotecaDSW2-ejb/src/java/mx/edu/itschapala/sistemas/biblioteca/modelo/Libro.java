...
@NamedQueries({
    ...
    @NamedQuery(name = "Libro.findByLibrocolor", query = "SELECT l FROM Libro l WHERE l.librocolor = :librocolor")})
public class Libro implements Serializable {
    ...
    @Size(max = 45)
    @Column(name = "librocolor")
    private String librocolor;
    ...
    public String getLibrocolor() {
        return librocolor;
    }

    public void setLibrocolor(String librocolor) {
        this.librocolor = librocolor;
    }
