...
public class Usuario implements Serializable {
    ...
    public Usuario(Integer id, String nombre, String apellidopaterno, String telefono, String sexo, String direccion, String colonia, String ciudad, String estado) {
        this.id = id;
        this.nombre = nombre;
