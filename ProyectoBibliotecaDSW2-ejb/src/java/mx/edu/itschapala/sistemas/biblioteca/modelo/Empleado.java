...
public class Empleado implements Serializable {
    ...
    public Empleado(Integer id, String nombre, String apellidoPaterno, String telefono, String sexo, String direccion, String colonia, String ciudad, String estado) {
        this.id = id;
        this.nombre = nombre;
